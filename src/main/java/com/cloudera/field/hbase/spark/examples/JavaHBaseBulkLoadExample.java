package com.cloudera.field.hbase.spark.examples;
...
import com.cloudera.field.hbase.spark.HBaseBulkPutWrapper;
...
public class JavaHBaseBulkLoadExample {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("TRISTAN: " + (sparkConf==null));
    ...
    try {
      ...
      bpw.bulkLoad(rdd, TableName.valueOf(tableName),new BulkLoadFunction(), "Table1",
