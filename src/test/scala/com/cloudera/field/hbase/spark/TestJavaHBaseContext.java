...
//      HBaseClassTestRule.forClass(TestJavaHBaseContext.class);
  ...
  public void testBulkLoad() throws Exception {
    ...
    HBaseBulkPutWrapper bpw = new HBaseBulkPutWrapper(hbaseContext);

    bpw.bulkLoad(rdd, TableName.valueOf(tableName), new BulkLoadFunction(),
  ...
  public void testBulkLoadThinRows() throws Exception {
    ...
    bpw.bulkLoadThinRows(rdd, TableName.valueOf(tableName), new BulkLoadThinRowsFunction(),
  ...
  public static class BulkLoadThinRowsFunction
      implements Function<List<String>, Pair<ByteArrayWrapper, FamiliesQualifiersValuesJ>> {
    @Override public Pair<ByteArrayWrapper, FamiliesQualifiersValuesJ> call(List<String> list) {
      if (list == null) {
        return null;
      }

      ByteArrayWrapper rowKey = null;
      FamiliesQualifiersValuesJ fqv = new FamiliesQualifiersValuesJ();
